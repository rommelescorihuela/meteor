        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                Yii::$app->glide->createSignedUrl([
                    'glide/index',
                    'path' => Yii::$app->user->identity->userProfile->getAvatar('/img/anonymous.png'),
                    'w' => 200
                ], true),
            ...
            <nav class="mt-2">
                <?php echo MainSidebarMenu::widget([
                    ...
                    'items' => [
                        ...
                        [
                            'label' => Yii::t('backend', 'Register'),
                            'url' => ['datos-organizacion/index'],
                            'icon' => FAS::icon('pencil-alt', ['class' => ['nav-icon']]),
                        ],
                        [
                            'label' => Yii::t('backend', 'Courses'),
                            'url' => ['taller/index'],
                            'icon' => FAR::icon('', ['class' => ['nav-icon','fas fa-chalkboard-teacher']]),
