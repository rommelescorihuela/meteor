...
namespace frontend\modules\alumnos\controllers;

use common\commands\SendEmailCommand;
use common\models\User;
use common\models\UserToken;
use frontend\modules\alumnos\models\LoginForm;
use frontend\modules\alumnos\models\PasswordResetRequestForm;
use frontend\modules\alumnos\models\ResetPasswordForm;
use frontend\modules\alumnos\models\SignupForm;
use frontend\modules\alumnos\models\ResendEmailForm;
use Yii;
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'denyCallback' => function () {
                            return Yii::$app->controller->redirect(['/alumnos/default/index']);
                        }
                    ],
                    [
                        'actions' => ['logout'],
